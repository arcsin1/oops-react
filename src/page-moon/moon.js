...
import HomeStore from './store-moon'
import star from './canvas'
import './moon.styl'
...
class Moon extends Component {
  ...
  render() {
    return (
      <div className="page-moon FBH FBAC FBJC">
        <canvas id="canvas" />
        <div className="moon">
          <div className="love">
        ...
        <div className="container">
          <div className="developer">
            <div className="desk" />
            <div className="deskcounter" />
            <div className="book1" />
            <div className="book1-ring" />
            <div className="book1-line1" />
            <div className="book1-line2" />
            <div className="book2" />
            <div className="book2-ring" />
            <div className="book2-line1" />
            <div className="book2-line2" />
            <div className="book3" />
            <div className="book3-ring" />
            <div className="book3-line1" />
            <div className="book3-line2" />
            <i className="fab fa-apple" />
            <div className="worker">
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 777 392">
                <defs>
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  <path fill="#05451c" d="M415,187 C415,187 376,194 366,203 C362.988968,205.709928 329.637386,236.421319 305.095167,259.010557 C305.095167,259.010557 333.212929,281.908364 332,283 L337,346 L540,346 L545,283 L570.333229,259.00712 C547.358592,237.435001 516.847183,208.885387 509,203 C497,194 462,187 462,187 L415,187 Z" />
                  ...
                  <rect className="midarmright" width="33" height="3" x="542" y="289.219" fill="#EFC7B0" transform="rotate(-15 558.5 290.72)" />
                  <rect className="midarmleft" width="33" height="3" x="301.826" y="289.219" fill="#EFC7B0" transform="scale(-1 1) rotate(-15 0 2708.645)" />
                  ...
                  <path stroke="#E0ADA6" strokeWidth="3" d="M414,154 C414,154 424,162 439,162 C454,162 463,154 463,154" strokeLinecap="round" />
                  ...
                  <rect width="24" height="6" x="398.659" y="109.038" fill="#000000" transform="rotate(-10 410.659 112.038)" rx="3" />
                  <rect width="24" height="6" x="454.339" y="109.038" fill="#000000" transform="rotate(10 466.339 112.038)" rx="3" />
                </g>
              </svg>
            </div>
          </div>
